...
public class SudokuSolver {
	...
	public static void main(String[] args) {
		...
		// }
		// }
		int[][] matrix = { { 8, 7, 6, 5, 4, 3, 0, 9, 0 }, { 5, 4, 3, 2, 1, 0, 7, 6, 8 }, { 2, 1, 9, 0, 7, 6, 4, 3, 5 },
				{ 1, 0, 0, 0, 0, 5, 3, 2, 4 }, { 4, 3, 2, 1, 9, 8, 6, 5, 7 }, { 7, 0, 5, 4, 0, 2, 9, 8, 1 },
				{ 3, 0, 1, 9, 8, 7, 5, 4, 6 }, { 6, 0, 4, 3, 2, 1, 8, 7, 9 }, { 9, 8, 7, 6, 5, 4, 2, 1, 3 } };
